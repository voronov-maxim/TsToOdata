...
var QueryTests =
    ...
    function () {
        ...
        QueryTests.prototype.applyFilter = function () {//not applicable
        };

        QueryTests.prototype.applyFilterGroupBy = function () {
            var url = this.context.Orders.filter("Status eq OdataToEntity.Test.Model.OrderStatus'Unknown'").groupby("[{\"expression\":\"Name\",\"alias\":\"Name\",\"kind\":0}]").select("[{\"expression\":\"Id with countdistinct\",\"alias\":\"cnt\",\"kind\":2}]").getQueryUrl();
            ...
            var scope = {
                orderStatus: this.odataNamespace + '.OrderStatus' + "'" + oe.OrderStatus.Unknown + "'"
            };
            var url2 = this.context.Orders.filter("Status eq {orderStatus}", scope).groupby("[{\"expression\":\"Name\",\"alias\":\"Name\",\"kind\":0}]").select("[{\"expression\":\"Id with countdistinct\",\"alias\":\"cnt\",\"kind\":2}]").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByAggregate = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"OrderId\",\"kind\":0},{\"expression\":\"Order/Status\",\"alias\":\"Status\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price with average\",\"alias\":\"avg\",\"kind\":2},{\"expression\":\"Product with countdistinct\",\"alias\":\"dcnt\",\"kind\":2},{\"expression\":\"Price with max\",\"alias\":\"max\",\"kind\":2},{\"expression\":\"Order/Status with max\",\"alias\":\"max_status\",\"kind\":2},{\"expression\":\"Price with min\",\"alias\":\"min\",\"kind\":2},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2},{\"expression\":\"$count\",\"alias\":\"cnt\",\"kind\":2}]").orderby("orderId").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByAggregateCompute = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"Order/Id\",\"alias\":\"Id\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"Name\",\"kind\":0}]").select("[{\"expression\":\"Order/Id\",\"alias\":\"id\",\"kind\":0},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2},{\"expression\":\"length(Order/Name)\",\"alias\":\"nameLength\",\"kind\":1}]").orderby("id").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByAggregateFilter = function () {
            var url = this.context.OrderItems.filter("Price lt 2").groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2}]").filter("sum gt 0").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByAggregateFilterOrdinal = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2}]").filter("OrderId eq 2 and sum ge 4").getQueryUrl();
            this.equal('OrderItems?$apply=groupby((OrderId),aggregate(Price with sum as sum))&$filter=OrderId eq 2 and sum ge 4', url);
            var scope = {
                orderId: 2,
                sum: 4
            };
            var url2 = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2}]").filter("OrderId eq {orderId} and sum ge {sum}", scope).getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.applyGroupByAggregateOrderBy = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price with sum\",\"alias\":\"sum\",\"kind\":2}]").orderby("sum").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByFilter = function () {
            var url = this.context.OrderItems.filter("OrderId eq 1 and Order/Name eq 'Order 1'").groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"name\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"orderName\",\"kind\":0}]").getQueryUrl();
            this.equal("OrderItems?$apply=filter(OrderId eq 1 and Order/Name eq 'Order 1')/groupby((OrderId,Order/Name))", url);
            var scope = {
                orderName: 'Order 1'
            };
            var url2 = this.context.OrderItems.filter("OrderId eq 1 and Order/Name eq {orderName}", scope).groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"name\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"orderName\",\"kind\":0}]").getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.applyGroupByMul = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price mul Count with sum\",\"alias\":\"sum\",\"kind\":2}]").orderby("orderId").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByOrderBy = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"name\",\"kind\":0}]").orderbyDescending("key/orderId").orderby("key/name").getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByOrderBySkipTop = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Order/Name\",\"alias\":\"name\",\"kind\":0}]").orderbyDescending("key/orderId").orderby("key/name").skip(1).top(1).getQueryUrl();
        ...
        QueryTests.prototype.applyGroupBySkip = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").orderby("key/orderId").skip(1).getQueryUrl();
            this.equal('OrderItems?$apply=groupby((OrderId))&$orderby=OrderId&$skip=1', url);
        };

        QueryTests.prototype.applyGroupByTop = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").orderby("key/orderId").top(1).getQueryUrl();
        ...
        QueryTests.prototype.applyGroupByVirtualCount = function () {
            var url = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"substring(Product,0,10) with countdistinct\",\"alias\":\"dcnt\",\"kind\":2},{\"expression\":\"$count\",\"alias\":\"cnt\",\"kind\":2}]").filter("dcnt ne cnt").orderby("orderId").getQueryUrl();
            ...
            var url2 = this.context.OrderItems.groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"substring(Product,{pos1},{pos2}) with countdistinct\",\"alias\":\"dcnt\",\"kind\":2},{\"expression\":\"$count\",\"alias\":\"cnt\",\"kind\":2}]", scope).filter("dcnt ne cnt").orderby("orderId").getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.compute = function () {
            var url = this.context.OrderItems.expand("Order").select("[{\"expression\":\"Product\",\"alias\":\"product\",\"kind\":0},{\"expression\":\"Count mul Price\",\"alias\":\"Total\",\"kind\":1},{\"expression\":\"Id add OrderId\",\"alias\":\"SumId\",\"kind\":1}]").getQueryUrl();
            this.equal('OrderItems?$expand=Order&$select=Product&$compute=Count mul Price as Total,Id add OrderId as SumId', url);
        };

        QueryTests.prototype.count = function () {//not applicable
        ...
        QueryTests.prototype.expand = function () {
            var url = this.context.Orders.expand("Customer").expand("Items").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandCollectionSingleSelectNestedName = function () {
            var url = this.context.Customers.expand("CustomerShippingAddresses").thenExpand("ShippingAddress").thenSelect("[{\"expression\":\"Address\",\"alias\":\"p\",\"kind\":0}]").asEntitySet().orderby("Country").orderby("Id").select("[{\"expression\":\"Name\",\"alias\":\"p\",\"kind\":0}]").getQueryUrl();
        ...
        QueryTests.prototype.expandManyToMany = function () {
            var url = this.context.Customers.expand("AltOrders").expand("ShippingAddresses").expand("Orders").orderby("Country").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandAndSelect = function () {
            var url = this.context.Orders.expand("AltCustomer").expand("Customer").expand("Items").thenOrderby("Id").expand("ShippingAddresses").thenOrderby("Id").select("[{\"expression\":\"AltCustomerCountry\",\"alias\":\"p1\",\"kind\":0},{\"expression\":\"AltCustomerId\",\"alias\":\"p2\",\"kind\":0},{\"expression\":\"CustomerCountry\",\"alias\":\"p3\",\"kind\":0},{\"expression\":\"CustomerId\",\"alias\":\"p4\",\"kind\":0},{\"expression\":\"Date\",\"alias\":\"p5\",\"kind\":0},{\"expression\":\"Id\",\"alias\":\"p6\",\"kind\":0},{\"expression\":\"Name\",\"alias\":\"p7\",\"kind\":0},{\"expression\":\"Status\",\"alias\":\"p8\",\"kind\":0}]").orderby("p6").getQueryUrl();
        ...
        QueryTests.prototype.expandExpandFilter = function () {
            var url = this.context.Customers.expand("AltOrders").thenExpand("Items").thenFilter("contains(Product,'unknown')").thenOrderby("Id").expand("Orders").thenExpand("Items").thenFilter("contains(Product,'unknown')").thenOrderby("Id").orderby("Country").orderby("Id").getQueryUrl();
            ...
            var product = 'unknown';
            var url2 = this.context.Customers.expand("AltOrders").thenExpand("Items").thenFilter("contains(Product,{product})", {
                product: product
            }).thenOrderby("Id").expand("Orders").thenExpand("Items").thenFilter("contains(Product,{product})", {
                product: product
            }).thenOrderby("Id").orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.expandExpandMany = function () {
            var url = this.context.Customers.expand("AltOrders").thenExpand("Items").thenOrderbyDescending("Price").expand("AltOrders").thenExpand("ShippingAddresses").thenOrderbyDescending("Id").expand("Orders").thenExpand("Items").thenOrderbyDescending("Price").expand("Orders").thenExpand("ShippingAddresses").thenOrderbyDescending("Id").orderby("Country").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandExpandOne = function () {
            var url = this.context.OrderItems.expand("Order").thenExpand("AltCustomer").expand("Order").thenExpand("Customer").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandExpandOrderBy = function () {
            var url = this.context.Customers.expand("Orders").thenExpand("Items").thenOrderbyDescending("Id").orderby("Country").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandExpandSkipTop = function () {
            var url = this.context.Customers.expand("AltOrders").thenExpand("Items").thenOrderby("Id").thenTop(1).expand("Orders").thenExpand("Items").thenOrderby("Id").thenTop(1).orderby("Country").orderby("Id").skip(1).top(3).getQueryUrl();
        ...
        QueryTests.prototype.expandInverseProperty = function () {
            var url = this.context.Customers.expand("AltOrders").expand("Orders").orderby("Country").orderby("Id").getQueryUrl();
            this.equal('Customers?$expand=AltOrders,Orders&$orderby=Country,Id', url);
        };

        QueryTests.prototype.expandManyFilter = function () {
            var url = this.context.Customers.expand("Orders").thenFilter("Status eq OdataToEntity.Test.Model.OrderStatus'Processing'").orderby("Country").orderby("Id").getQueryUrl();
            ...
            var orderStatus;
            var url2 = this.context.Customers.expand("Orders").thenFilter("Status eq {orderStatus}", {
                orderStatus: this.odataNamespace + '.OrderStatus\'Processing\''
            }).orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.expandNestedSelect = function () {
            var url = this.context.Customers.expand("Orders").thenSelect("[{\"expression\":\"AltCustomerCountry\",\"alias\":\"p1\",\"kind\":0},{\"expression\":\"AltCustomerId\",\"alias\":\"p2\",\"kind\":0},{\"expression\":\"CustomerCountry\",\"alias\":\"p3\",\"kind\":0},{\"expression\":\"CustomerId\",\"alias\":\"p4\",\"kind\":0},{\"expression\":\"Date\",\"alias\":\"p5\",\"kind\":0},{\"expression\":\"Id\",\"alias\":\"p6\",\"kind\":0},{\"expression\":\"Name\",\"alias\":\"p7\",\"kind\":0},{\"expression\":\"Status\",\"alias\":\"p8\",\"kind\":0}]").asEntitySet().orderby("Country").orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandNullableNestedSelect = function () {
            var url = this.context.Orders.expand("AltCustomer").thenSelect("[{\"expression\":\"Address\",\"alias\":\"p1\",\"kind\":0},{\"expression\":\"Country\",\"alias\":\"p2\",\"kind\":0},{\"expression\":\"Id\",\"alias\":\"p3\",\"kind\":0},{\"expression\":\"Name\",\"alias\":\"p4\",\"kind\":0},{\"expression\":\"Sex\",\"alias\":\"p5\",\"kind\":0}]").asEntitySet().orderby("Id").getQueryUrl();
        ...
        QueryTests.prototype.expandOneFilter = function () {
            var url = this.context.Orders.expand("AltCustomer").thenFilter("Sex eq OdataToEntity.Test.Model.Sex'Male'").getQueryUrl();
            this.equal("Orders?$expand=AltCustomer($filter=Sex eq OdataToEntity.Test.Model.Sex'Male')", url);
            var sex = oe.Sex.Male;
            var url2 = this.context.Orders.expand("AltCustomer").thenFilter("Sex eq {sex}", {
                sex: this.odataNamespace + '.Sex\'Male\''
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };

        QueryTests.prototype.expandStar = function () {//not applicable
        };
        ...
        QueryTests.prototype.filterAll = function () {
            ...
            var price = 2.1;
            var url2 = this.context.Orders.filter("Items/all(d:d/Price ge {price})", {
                price: price
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterAndHaving = function () {
            var url = this.context.OrderItems.filter("Order/CustomerCountry ne 'UN'").groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price mul Count with sum\",\"alias\":\"sum\",\"kind\":2}]").filter("sum gt 7").getQueryUrl();
            ...
            var url2 = this.context.OrderItems.filter("Order/CustomerCountry ne {customerCountry}", scope).groupby("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0}]").select("[{\"expression\":\"OrderId\",\"alias\":\"orderId\",\"kind\":0},{\"expression\":\"Price mul Count with sum\",\"alias\":\"sum\",\"kind\":2}]").filter("sum gt {sum}", scope).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterAny = function () {
            ...
            var count = 2;
            var url2 = this.context.Orders.filter("Items/any(d:d/Count gt {count})", {
                count: count
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterCount = function () {
            ...
            var length = 2;
            var url2 = this.context.Orders.filter("Items/$count gt {length}", {
                length: length
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterDateTime = function () {
            ...
            var url = this.context.Categories.filter("DateTime ge {dt}", {
                dt: dt
            }).getQueryUrl();
        ...
        QueryTests.prototype.filterDateTimeNull = function () {
            ...
            var dt = null;
            var url2 = this.context.Categories.filter("DateTime eq {dt}", {
                dt: dt
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterDecimal = function () {
            ...
            var price = 2;
            var url2 = this.context.OrderItems.filter("Price gt {price}", {
                price: price
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterDecimalNull = function () {
            ...
            var price = null;
            var url2 = this.context.OrderItems.filter("Price eq {price}", {
                price: price
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterEnum = function () {
            ...
            var scope = {
                sex: 'OdataToEntity.Test.Model.Sex\'Female\''
            };
        ...
        QueryTests.prototype.filterEnumNullableGe = function () {
            ...
            var scope = {
                sex: 'OdataToEntity.Test.Model.Sex\'Male\''
            };
        ...
        QueryTests.prototype.filterIn = function () {
            ...
            var url2 = this.context.OrderItems.filter("Price in ({items})", {
                items: items
        ...
        QueryTests.prototype.filterInEnum = function () {
            ...
            var scope = {
                items: ['OdataToEntity.Test.Model.Sex\'Male\'', 'OdataToEntity.Test.Model.Sex\'Female\'']
            };
        ...
        QueryTests.prototype.filterIntNull = function () {
            ...
            var count = null;
            var url2 = this.context.OrderItems.filter("Count eq {count}", {
                count: count
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterSegment = function () {//not supported
        };
        ...
        QueryTests.prototype.filterStringEq = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address eq {address}", {
                address: address
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringGe = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address ge {address}", {
                address: address
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringGt = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address gt {address}", {
                address: address
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringLe = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address le {address}", {
                address: address
            }).orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringLt = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address lt {address}", {
                address: address
            }).orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringNe = function () {
            ...
            var address = 'Tula';
            var url2 = this.context.Customers.filter("Address ne {address}", {
                address: address
            }).orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringEndsWith = function () {
            ...
            var str = 'asha';
            var url2 = this.context.Customers.filter("endswith(Name,{str})", {
                str: str
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringLength = function () {
            ...
            var length = 5;
            var url2 = this.context.Customers.filter("length(Name) eq {length}", {
                length: length
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringIndexOf = function () {
            ...
            var pos = 1;
            var url2 = this.context.Customers.filter("indexof(Name,'asha') eq {pos}", {
                pos: pos
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringStartsWith = function () {
            ...
            var str = 'S';
            var url2 = this.context.Customers.filter("startswith(Name,{str})", {
                str: str
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringToLower = function () {
            ...
            var name = 'sasha';
            var url2 = this.context.Customers.filter("tolower(Name) eq {name}", {
                name: name
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringToUpper = function () {
            ...
            var name = 'SASHA';
            var url2 = this.context.Customers.filter("toupper(Name) eq {name}", {
                name: name
            }).getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.filterStringTrim = function () {
            ...
            var space = ' ';
            var url2 = this.context.Customers.filter("trim(concat(Name,{space})) eq trim(Name)", {
                space: space
            }).orderby("Country").orderby("Id").getQueryUrl();
            this.equalUrl(url, url2);
        };
        ...
        QueryTests.prototype.keyComposition = function () {
            var url = this.context.Customers.key({
                Country: 'RU',
                Id: 1
            }).getQueryUrl();
        ...
        QueryTests.prototype.keyExpand = function () {
            var url = this.context.Orders.key(1).expand("Customer").expand("Items").getQueryUrl();
        ...
        QueryTests.prototype.mathFunctions = function () {
            var url = this.context.OrderItems.select("[{\"expression\":\"Price\",\"alias\":\"Price\",\"kind\":0},{\"expression\":\"ceiling(Price)\",\"alias\":\"Ceiling\",\"kind\":1},{\"expression\":\"floor(Price)\",\"alias\":\"Floor\",\"kind\":1},{\"expression\":\"round(Price)\",\"alias\":\"Round\",\"kind\":1}]").orderby("Price").getQueryUrl();
        ...
        QueryTests.prototype.orderByColumnsMissingInSelect = function () {
            var url = this.context.OrderItems.orderbyDescending("Count").orderby("Order/Customer/Name").orderbyDescending("Id").select("[{\"expression\":\"Product\",\"alias\":\"p1\",\"kind\":0},{\"expression\":\"Id\",\"alias\":\"p2\",\"kind\":0}]").getQueryUrl();
        ...
        QueryTests.prototype.orderByColumnsMissingInSelectNavigationFirst = function () {
            var url = this.context.OrderItems.orderbyDescending("Order/Customer/Name").orderby("Count").orderbyDescending("Id").select("[{\"expression\":\"Product\",\"alias\":\"p1\",\"kind\":0},{\"expression\":\"Id\",\"alias\":\"p2\",\"kind\":0}]").getQueryUrl();
        ...
        QueryTests.prototype.parameterization = function () {
            var url = this.context.Orders.filter("AltCustomerId eq 3 and CustomerId eq 4 and (year(Date) eq 2016 and month(Date) gt 11 and day(Date) lt 20 or Date eq null) and contains(Name,'unknown') and Status eq OdataToEntity.Test.Model.OrderStatus'Unknown'").expand("Items").thenFilter("(Count eq 0 or Count eq null) and (Price eq 0 or Price eq null) and (contains(Product,'unknown') or contains(Product,'null')) and OrderId gt -1 and Id ne 1").getQueryUrl();
        ...
        QueryTests.prototype.selectNestedName = function () {
            var url = this.context.Orders.expand("Items").thenFilter("OrderId eq 1").thenSelect("[{\"expression\":\"Product\",\"alias\":\"p\",\"kind\":0}]").asEntitySet().select("[{\"expression\":\"Name\",\"alias\":\"p\",\"kind\":0}]").getQueryUrl();
        ...
        QueryTests.prototype.timeDateTimeFunction = function () {
            var url = this.context.Categories.select("[{\"expression\":\"DateTime\",\"alias\":\"DateTime\",\"kind\":0},{\"expression\":\"hour(DateTime)\",\"alias\":\"Hour\",\"kind\":1},{\"expression\":\"minute(DateTime)\",\"alias\":\"Minute\",\"kind\":1},{\"expression\":\"second(DateTime)\",\"alias\":\"Second\",\"kind\":1}]").orderby("DateTime").getQueryUrl();
        ...
        QueryTests.prototype.timeDateTimeOffsetFunction = function () {
            var url = this.context.Orders.select("[{\"expression\":\"Date\",\"alias\":\"Date\",\"kind\":0},{\"expression\":\"hour(Date)\",\"alias\":\"Hour\",\"kind\":1},{\"expression\":\"minute(Date)\",\"alias\":\"Minute\",\"kind\":1},{\"expression\":\"second(Date)\",\"alias\":\"Second\",\"kind\":1}]").orderby("Date").getQueryUrl();
        ...
        QueryTests.prototype.equal = function (expected, actual) {
            ...
            if (expectedQuery !== actualQuery) throw 'expected: ' + expectedQuery + '\r\n' + 'actual: ' + actualQuery;
            console.log(expected); //this.execute(actual);
        };

        QueryTests.prototype.equalUrl = function (expected, actual) {
            if (expected.href !== actual.href) throw 'expected href: ' + expected.href + '\r\n' + 'actual href: ' + actual.href;
        };
        ...
        QueryTests.prototype.execute = function (queryUrl) {
            ...
            cross_fetch_1.fetch(request).then(function (r) {
...
exports.QueryTests = QueryTests; //# sourceMappingURL=QueryTests.js.map